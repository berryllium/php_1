...
function translit($str) {
  ...
  $str = preg_match_all('/./u', $str, $matches);
  $str = $matches[0];
  $result = [];
...
echo translit('строка для примера').'<br>';
...
echo changeSpace('какая-то строка просто');
...
echo '<a href = "../hw1/minimalistica/" target="_blank">Реализовал на странице</a>';
